  ...
  return (
    <Headless.Switch
      ...
      className={clsx(
        className,
        // Base styles
        "cursor-pointer group relative isolate inline-flex h-6 w-10 cursor-default rounded-full p-[3px] sm:h-5 sm:w-8",
        // Transitions
        ...
        // Disabled
        "cursor-default data-disabled:bg-zinc-200 data-disabled:opacity-50 data-disabled:data-checked:bg-zinc-200 data-disabled:data-checked:ring-black/5",
