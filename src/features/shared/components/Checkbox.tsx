...
const base = [
  // Basic layout
  "cursor-pointer relative isolate flex size-4.5 items-center justify-center rounded-[0.3125rem] sm:size-4",
  ...
  // Disabled state
  "cursor-default group-data-disabled:opacity-50",
...
export function Checkbox({
  ...
  return (
    ...
    >
      <span className={clsx([base, colors[color], sizes.mobile])}>
        <svg
          className={clsx(
